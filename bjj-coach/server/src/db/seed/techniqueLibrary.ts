...
const LIBRARY: Record<Category, Record<string, string[]>> = {
  submission: {
    ...
    'Guillotine Choke': ['Half Guard (10 Finger)', 'Turtle Position (Arm-In)', 'Butterfly Guard (With Sweep)', 'Closed Guard', 'Front Headlock', 'Guard Pull', 'Half Guard', 'Standing', 'Half Guard (High Elbow)', 'Half Guard (Power)', 'Octopus Guard'],
  ...
  back_take: {
    ...
    'Octopus Guard Back Take': ['Octopus Guard'],
  ...
  sweep: {
    ...
    'Hip Bump Sweep': ['Closed Guard', 'Octopus Guard'],
    ...
    'Wrestle-Up': ['Octopus Guard'],
    'Back Roll Sweep': ['Octopus Guard'],
    'Outside Hook (Kosoto) Sweep': ['Octopus Guard'],
