...
export type IconSvgData = readonly (readonly [string, Record<string, unknown>])[];

export type IconVariant = 'stroke' | 'stroke-sharp' | 'solid' | 'solid-sharp' | 'auto';

type IconVariants = Partial<Record<IconVariant, IconSvgData>>;
...
export function resolveIcon(name: IconName, variant: IconVariant): IconSvgData {
